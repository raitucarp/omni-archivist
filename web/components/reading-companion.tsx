...
export function ReadingCompanion() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-2 left-2 sm:bottom-6 sm:left-6 z-40 flex items-center gap-1.5 p-1.5 rounded-full bg-card/90 backdrop-blur-md border border-border/80 shadow-lg text-xs font-semibold">
      ...
      <div className="fixed bottom-2 right-2 sm:bottom-6 sm:right-6 z-40 flex flex-col items-end gap-2.5">
