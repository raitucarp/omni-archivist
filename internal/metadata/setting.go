...
type Setting struct {
	...
	Function   string `yaml:"function" json:"function" jsonschema:"enum=decorative,enum=functional_causal,enum=symbolic,enum=affective,description=Function of setting in the narrative: decorative background, causal plot driver, symbolic meaning, or psychological/affective reflection"`
