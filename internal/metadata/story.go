...
type Story struct {
	...
	Structure    *Structure       `yaml:"structure,omitempty" json:"structure,omitempty" jsonschema:"description=The narrative structure of the story."`
	Plot         *Plot            `yaml:"plot,omitempty" json:"plot,omitempty" jsonschema:"description=Dramatic emplotment, conflict, and Freytag arc"`
	Characters   []Character      `yaml:"characters,omitempty" json:"characters,omitempty" jsonschema:"description=List of main characters in the story"`
	...
	POV          string           `yaml:"pov,omitempty" json:"pov,omitempty" jsonschema:"enum=first_person,enum=third_person_limited,enum=third_person_omniscient,description=Story point of view determines the narrator's perspective, influencing reader intimacy and information access."`
	ImagePrompt  string           `yaml:"image_prompt,omitempty" json:"image_prompt,omitempty" jsonschema:"description=Prompt for generating a visual, an image that represents the story."`
